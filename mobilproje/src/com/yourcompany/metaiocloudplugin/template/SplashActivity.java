...
public class SplashActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Utils.showErrorForCloudPluginResult(
					MetaioCloudPlugin.ERROR_CPU_NOT_SUPPORTED, this);
			return;
		}
	...
	public void startARELChannel(View v) {
		startChannel(405463, false);// start AREL test
	}

	public void startARELChannel2(View v) {
		startChannel(411405, false);// start AREL test
	}

	public void startARELChannel3(View v) {
		startChannel(417217, false);// start AREL test
	}
	...
	private class CloudPluginInitializerTask extends
			AsyncTask<Integer, Integer, Integer> {

		@Override
		protected void onPreExecute() {
			progressDialog = ProgressDialog.show(SplashActivity.this,
					"Metaio Cloud Plugin", "Starting up...");
		}
		...
		protected Integer doInBackground(Integer... params) {
			...
			final int result = MetaioCloudPlugin.initialize(this,
